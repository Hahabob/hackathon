...
const Header = ({
  ...
  return (
    <header className="sticky top-0 z-50 bg-background/95 dark:bg-background/90 ... border-b border-border dark:border-border">
      <div className="container flex h-16 items-center justify-between px-4">
        ...
        {showCart && (
          <Button
            ...
            className="relative h-10 w-10 text-primary dark:text-primary"
          >
